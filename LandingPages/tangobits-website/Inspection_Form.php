...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 title-info_form">
            ...
            <a href="Inspection_Landing.php"><img class="logo-display" src="./assets/images/Tangobits-logo.jpg"></a>
    ...
    <div class="row">
        <div class="container-fluid">
            ...
            <div
                ...
                <form id="inspector-form_landing" role="form">
...
<div class="col-xs-12 Mobile">
    ...
    <div class="row">
        <form id="inspector-form_landing-mobile" role="form">
